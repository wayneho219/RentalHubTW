...
def upgrade() -> None:
    # NOTE: PostGIS extension must be enabled before running this migration.
    # The postgis/postgis Docker image auto-enables it for POSTGRES_DB.
    # For bare metal: CREATE EXTENSION IF NOT EXISTS postgis;
